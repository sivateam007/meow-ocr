...
TTS_CAT_NAMES = {
    ...
    "ta-IN-PallaviNeural": ("Whiskers", "Female"),
    "ta-IN-ValluvarNeural": ("Tom", "Male"),
    "ta-LK-SaranyaNeural": ("Mittens", "Female"),
    "ta-LK-KumarNeural": ("Jasper", "Male"),
    "ta-MY-KaniNeural": ("Luna", "Female"),
    "ta-MY-SuryaNeural": ("Simba", "Male"),
    "ta-SG-VenbaNeural": ("Puffy", "Female"),
    "ta-SG-AnbuNeural": ("Smokey", "Male"),
